...
async def _run_demo(num_grasps_per_object: int):
    ...
    # Predict depth with the configured depth source
    if depth_estimator is not None:
        _log.info("Running %s depth inference", depth_source)
        ...
        _log.info("Using native hand-camera depth to build the M2T2 point cloud")
